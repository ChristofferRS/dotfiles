...
static const char *const autostart[] = {
	"wbg", "/home/chris/.cache/rndbg/wallpaper.jpg", NULL,
	NULL /* terminate */
};
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_f,          spawn,            SHCMD("firefox")},
    { MODKEY|ShiftMask,          XKB_KEY_question,   spawn,            SHCMD("sudo light -A 10")},
	{ MODKEY|ShiftMask,          XKB_KEY_underscore, spawn,            SHCMD("sudo light -U 10")},
    { MODKEY,                    XKB_KEY_plus,       spawn,            SHCMD("pamixer -i 5")},
	{ MODKEY,                    XKB_KEY_minus,       spawn,            SHCMD("pamixer -d 5")},
